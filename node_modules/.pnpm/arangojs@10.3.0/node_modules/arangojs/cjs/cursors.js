...
exports.Cursor = exports.BatchCursor = void 0;
/**
 * ```ts
...
class BatchCursor {
    ...
    constructor(db, body, hostUrl, allowDirtyRead) {
        const batches = new x3_linkedlist_js_1.LinkedList(body.result.length ? [new x3_linkedlist_js_1.LinkedList(body.result)] : []);
        this._db = db;
    ...
    async _more() {
        ...
        this._batches.push(new x3_linkedlist_js_1.LinkedList(body.result));
...
exports.BatchCursor = BatchCursor;
/**
