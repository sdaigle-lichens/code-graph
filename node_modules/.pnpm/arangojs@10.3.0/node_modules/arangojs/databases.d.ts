...
export declare class Database {
     ...
     * ```
     */
    createAccessToken(username: string, options: users.CreateAccessTokenOptions): Promise<connection.ArangoApiResponse<users.AccessToken>>;
    /**
     ...
     * ```
     */
    getAccessTokens(username: string): Promise<users.AccessTokenMetadata[]>;
    /**
     ...
     * ```
     */
    deleteAccessToken(username: string, tokenId: number): Promise<void>;
    /**
